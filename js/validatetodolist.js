        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                for (var i = 0; i < content.length; i++) {
                    ...
                    out += `
                <div class="col pb-2"><div onclick='select(${i});' class="card" selected="5" id="${i}">
<div class="card-body">
...
${title}
                ...
                datainfo.innerHTML = "<div class='mb-3 text-center '>Click On Link To See The cards.</div><div class='d-flex justify-content-center'><div class='row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4'>" + out + "</div></div>";
